...
<div class="min-h-screen bg-gray-50/50 py-12 px-4">
    <main class="max-w-5xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
            ...
            <?php if (!$isAdmin): ?>
           <a href="/hiihi/post_new.php" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-xl shadow-md shadow-blue-100 hover:bg-blue-700 active:scale-95 transition-all w-fit">
